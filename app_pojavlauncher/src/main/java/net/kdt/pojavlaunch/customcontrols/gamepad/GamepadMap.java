...
public class GamepadMap {
   ...
   */
    ...
    public static String[] getSpecialKeycodeNames() {
        return new String[] {
                PojavApplication.getContext().getString(R.string.keycode_string_unspecified),
                PojavApplication.getContext().getString(R.string.keycode_string_mouse_right),
                PojavApplication.getContext().getString(R.string.keycode_string_mouse_middle),
                PojavApplication.getContext().getString(R.string.keycode_string_mouse_left),
                PojavApplication.getContext().getString(R.string.keycode_string_scroll_up),
                PojavApplication.getContext().getString(R.string.keycode_string_scroll_down)
        };
    }
}
